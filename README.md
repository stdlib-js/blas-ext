...
```javascript
import { base, circshift, copyWithin, cusum, findIndex, findLastIndex, indexOf, join, lastIndexOf, linspace, logspace, oneTo, sort, sorthp, sum, toSorted, toSortedhp, unitspace, zeroTo } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext@deno/mod.js';
```
