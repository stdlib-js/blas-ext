...
```javascript
import { base, circshift, cusum, findIndex, findLastIndex, indexOf, join, lastIndexOf, linspace, sorthp, sum, toSortedhp } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext@deno/mod.js';
```
