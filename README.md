...
```javascript
import { base, circshift, copyWithin, cusum, findIndex, findLastIndex, indexOf, join, lastIndexOf, linspace, logspace, oneTo, sort, sorthp, sum, toSorted, toSortedhp, unitspace, zeroTo } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext@esm/index.mjs';
```
...
-   <span class="signature">[`logspace( shape, base, start, stop[, endpoint][, options] )`][@stdlib/blas/ext/logspace]</span><span class="delimiter">: </span><span class="description">return a new ndarray filled with logarithmically spaced values over a specified interval along one or more ndarray dimensions.</span>
...
[@stdlib/blas/ext/circshift]: https://github.com/stdlib-js/blas-ext-circshift/tree/esm

[@stdlib/blas/ext/copy-within]: https://github.com/stdlib-js/blas-ext-copy-within/tree/esm
...
[@stdlib/blas/ext/join]: https://github.com/stdlib-js/blas-ext-join/tree/esm
...
[@stdlib/blas/ext/logspace]: https://github.com/stdlib-js/blas-ext-logspace/tree/esm

[@stdlib/blas/ext/one-to]: https://github.com/stdlib-js/blas-ext-one-to/tree/esm

[@stdlib/blas/ext/sort]: https://github.com/stdlib-js/blas-ext-sort/tree/esm
...
[@stdlib/blas/ext/to-sorted]: https://github.com/stdlib-js/blas-ext-to-sorted/tree/esm

[@stdlib/blas/ext/to-sortedhp]: https://github.com/stdlib-js/blas-ext-to-sortedhp/tree/esm

[@stdlib/blas/ext/unitspace]: https://github.com/stdlib-js/blas-ext-unitspace/tree/esm

[@stdlib/blas/ext/zero-to]: https://github.com/stdlib-js/blas-ext-zero-to/tree/esm
