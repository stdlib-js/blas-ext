...
```javascript
import { base, cusum, findIndex, findLastIndex, indexOf, lastIndexOf, linspace, sorthp, sum, toSortedhp } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext@deno/mod.js';
```
